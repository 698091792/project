...
const translations: Translations = {
  en: {
    ...
    bbb: 'The best investment you can make is in your own skills',
    bb: 'Dont compete to be the best. Compete to be unique.',
    test: 'Testimonials',
  ...
  "m": "Améliorer l'EdTech au Cameroun",
  "bbb": "Le meilleur investissement que vous puissiez faire est dans vos propres compétences",
  "bb":"Ne rivalisez pas pour être le meilleur. Rivalisez pour être unique.",
  "test": "Témoignages",
